...
// Source: database/transactionDb.go
...
// GetUnPaidTransactions mocks base method.
func (m *MockTransactionDatabase) GetUnPaidTransactions() ([]model.Transaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetUnPaidTransactions")
	ret0, _ := ret[0].([]model.Transaction)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetUnPaidTransactions indicates an expected call of GetUnPaidTransactions.
func (mr *MockTransactionDatabaseMockRecorder) GetUnPaidTransactions() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUnPaidTransactions", reflect.TypeOf((*MockTransactionDatabase)(nil).GetUnPaidTransactions))
}

// UpdateBalance mocks base method.
func (m *MockTransactionDatabase) UpdateBalance(unPaidTranactions []model.Transaction, transaction model.Transaction) (uint, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UpdateBalance", unPaidTranactions, transaction)
	ret0, _ := ret[0].(uint)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockTransactionDatabaseMockRecorder) UpdateBalance(unPaidTranactions, transaction interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateBalance", reflect.TypeOf((*MockTransactionDatabase)(nil).UpdateBalance), unPaidTranactions, transaction)
}
